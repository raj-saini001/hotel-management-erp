...
export const CompletedBookings = () => {
  ...
  const completedAll = bookings.filter((b) => b.bookingStatus === 'Checked Out');
  const filtered = completedAll.filter((b) => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Completed Stays & Checked Out Guests"
        subtitle="Historical list of guests who have checked out"
        action={
          <div className="w-full sm:w-64">
            <SearchBar
              ...
              placeholder="Search completed stays..."
            />
          </div>
        }
      />
