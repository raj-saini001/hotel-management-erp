...
export const UpcomingBookings = () => {
  ...
  const upcomingAll = bookings.filter((b) => b.bookingStatus === 'Confirmed');
  const filtered = upcomingAll.filter((b) => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Upcoming Guest Check-ins"
        subtitle="Confirmed reservations arriving in future dates"
        action={
          <div className="w-full sm:w-64">
            <SearchBar
              ...
              placeholder="Search upcoming guests..."
            />
          </div>
        }
      />
